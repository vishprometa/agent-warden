...
TypeScript SDK for [AgentWarden](https://github.com/agentwarden/agentwarden) — a runtime governance proxy for AI agents.
...
// Or from an existing AgentWarden instance:
// const mgmt = warden.management();
